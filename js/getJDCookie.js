 ...
 */
const UA =`Mozilla/5.0 (iPhone; CPU iPhone OS 13_3_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 SP-engine/2.14.0 main%2F1.0 baiduboxapp/11.18.0.16 (Baidu; P2 13.3.1) NABar/0.0`;
...
function formatCookie(headers) {
  new Promise(resolve => {
    ...
    var cmd = `echo "${cookie1}" > /tmp/getcookie.txt`;
